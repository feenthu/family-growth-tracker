...
function mortgageToApiMortgage(mortgage: Mortgage): any {
  return {
    ...
    interestRateApy: mortgage.interest_rate_apy || 0,
    termMonths: mortgage.term_months || 360,
    startDate: mortgage.start_date,
    scheduledPaymentCents: Math.round((mortgage.scheduled_payment || 0) * 100),
    paymentDay: mortgage.payment_day || 1,
    escrowEnabled: mortgage.escrow_enabled,
    escrowTaxesCents: mortgage.escrow_taxes !== undefined ? Math.round(mortgage.escrow_taxes * 100) : undefined,
    escrowInsuranceCents: mortgage.escrow_insurance !== undefined ? Math.round(mortgage.escrow_insurance * 100) : undefined,
    escrowMipCents: mortgage.escrow_mip !== undefined ? Math.round(mortgage.escrow_mip * 100) : undefined,
    escrowHoaCents: mortgage.escrow_hoa !== undefined ? Math.round(mortgage.escrow_hoa * 100) : undefined,
